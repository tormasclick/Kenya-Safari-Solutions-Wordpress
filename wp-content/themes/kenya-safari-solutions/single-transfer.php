...
<script>
// Single script for transfers - all functionality
function changeMainImage(element) {
    var newImageUrl = element.getAttribute('data-image');
    var mainImage = document.getElementById('main-transfer-image');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var mainImg = document.getElementById('main-transfer-image');
    if (mainImg) {
...
var waBtn = document.getElementById('transfer-wa');
if (waBtn) {
    var waNumber = "<?php echo esc_js(get_option('kenya_whatsapp_number', '254700563754')); ?>";
    var waMsg = "Hi, I'm interested in booking <?php echo addslashes(get_the_title()); ?> transfer. Can you share more details?";
